...
function handleGameUpdate(room) {
  ...
  document.getElementById('multi-p1-name').innerHTML = room.p1.nickname + ' ' + roleBadgeHTML(room.p1.nickname, 24);
  document.getElementById('multi-p2-name').innerHTML = room.p2.nickname + ' ' + roleBadgeHTML(room.p2.nickname, 24);
